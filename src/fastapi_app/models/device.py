...
class Device(Base):
    ...
    firmware_id = mapped_column(Integer, ForeignKey("firmware.id"), nullable=True)
    hardware_id = mapped_column(Integer, ForeignKey("hardware.id"), nullable=True)
    ...
    hardware = relationship("Hardware", back_populates="devices")
